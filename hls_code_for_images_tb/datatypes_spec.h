...
*   PARAMETERS
*/
const int IMG_HGHT = 500;
const int IMG_WDTH = 500;

const int M_ITERAT = 100;   // define max run iterations

const int DATA_DIM = 3;     // define dimensionality of data (x,y,z,...)
const int N_POINTS = IMG_HGHT*IMG_WDTH;  // define amount of points
